  ...
  task parts: :environment do
    ...
    csv.each do |row|
      ...
      if part.save!
        ...
        puts "Failed to save: #{part.errors.full_messages.join(", ")}"
      end
    end
  end
  ...
  task subcomponents: :environment do
    ...
    csv.each do |row|
      ...
      if subcomponent.save!
        puts "Success: #{subcomponent.inspect}"
      else
        puts "Failure: #{subcomponent.errors.full_messages.join(", ")}"
      end
    end
  end
  ...
  task quality_projects: :environment do
    ...
    csv.each do |row|
      ...
      if quality_project.save!
        puts "Saved: #{quality_project}"
      else
        puts "Failed to save: #{quality_project.errors.full_messages.join(", ")}"
      end
    end
  end
end
